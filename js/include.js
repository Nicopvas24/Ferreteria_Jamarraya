...
if (document.getElementById('navbar')) {
  cargar("navbar", "/Ferreteria_Jamarraya/components/navbar.html", "/Ferreteria_Jamarraya/components/header.css");
}

if (document.getElementById('footer')) {
  cargar("footer", "/Ferreteria_Jamarraya/components/footer.html", "/Ferreteria_Jamarraya/components/footer.css");
}


const s = document.createElement('script');
s.src = '/Ferreteria_Jamarraya/js/login.js';
