    ...
    <div class="pp-card" data-id="${p.id}">
      <div class="pp-card-img-wrap">
        ...
        <img
          ...
          alt="${p.nombre}"
          class="pp-card-img"
          onerror="this.src='../img/productos/nombreimagen.png'"
        />
...
function abrirModal(id) {
  ...
  $('#pp-modal-img').src     = `../img/productos/${p.imagen}`;
  $('#pp-modal-img').onerror = () => { $('#pp-modal-img').src = '../img/productos/nombreimagen.png'; };
