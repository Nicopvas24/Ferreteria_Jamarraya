...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // ── Modales ────────────────────────────────────
  // NOTA: El login es manejado por login.js que inyecta su propio modal
  // Aquí solo manejamos los modales que existen en la página
  ...
  // Abrir (solo si el modal existe en la página)
  if (modalRegister) {
    document.getElementById('btnRegister')?.addEventListener('click', (e) => { e.preventDefault(); openModal(modalRegister); });
  }

  // Cerrar con botón X
  document.getElementById('modalClose') ?.addEventListener('click', () => closeModal(modalLogin));
  document.getElementById('modalClose2')?.addEventListener('click', () => closeModal(modalRegister));

  // Cerrar con overlay
  if (modalLogin) {
    document.getElementById('modalOverlay') ?.addEventListener('click', () => closeModal(modalLogin));
  }
  if (modalRegister) {
    document.getElementById('modalOverlay2')?.addEventListener('click', () => closeModal(modalRegister));
  }
